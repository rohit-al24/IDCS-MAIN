    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs defaultValue="verified" className="w-full">
          ...
          {/* Verified tab now shows status 'pending' questions, can mark as unverified (move to verified list) */}
          <TabsContent value="verified">
            <Card>
              <CardHeader>
                <CardTitle>Verified Questions (Actually Pending)</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          {/* Unverified tab now shows status 'verified' questions, can mark as unverified */}
          <TabsContent value="unverified">
            <Card>
              <CardHeader>
                <CardTitle>Unverified Questions (Actually Verified)</CardTitle>
              </CardHeader>
              <CardContent>
